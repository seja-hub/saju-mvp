...
const SECTIONS = ['오늘의운세', '이번달운세', '총운', '연애운', '결혼운', '금전운', '직업운', '건강운', '궁합', '에겐테토', '인연사주', '단체궁합', '단체에겐테토', '술값귀인'];
const LABEL = { 오늘의운세: '오늘의 운세', 이번달운세: '이번 달 운세', 에겐테토: '에겐·테토', 인연사주: '인연 사주', 단체궁합: '단체 궁합', 단체에겐테토: '단체 에겐·테토', 술값귀인: '술값 귀인' };
